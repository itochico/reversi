...
int putStone(int x,int y,int player); //石を置けるか判定し、置ける場合は置いてひっくり返す
...
int whToPass(int player); //playerの手番がパスされるかどうか
int canPutStone(int x,int y,int player); //石を置ける場所が一箇所でも存在するか
